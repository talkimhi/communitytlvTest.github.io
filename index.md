...
<div class="row">
    ...
    <div class="row 20% uniform">
       ...
       <br/><strong>KEYNOTE</strong></p>
        ...
        <a href="#open-modal-2"><img src="assets/images/speakers/carmit.png" alt="Carmit Danon - Terasky" width="200" /></a>
        <ul class="icons">CARMIT DANON <br/> TERASKY <br/>
       ...
       <br/><strong>RANT SESSION</strong></p>
        ...
        <img src="assets/images/speakers/corey.png" alt="" width="200" />
        <ul class="icons">COREY QUINN <br/> DUCKBILL GROUP <br/>
        <li><a href="https://twitter.com/nukemberg" target="_blank" target="_blank" class="icon fa-twitter"></a></li>
        <li><a href="https://www.linkedin.com/in/nukemberg/"  target="_blank" class="icon fa-linkedin"></a></li>
        <li><a href="https://github.com/nukemberg" target="_blank" class="icon fa-github"></a></li>
        </ul></div>
...
<div class="row 20% uniform">
        ...
        <!-- <div class="2u"><img src="assets/images/speakers/carmit.png" alt="" width="200" /><ul class="icons">COREY QUINN | DUCKBILL GROUP <br/><li><a href="https://twitter.com/nukemberg" target="_blank" target="_blank" class="icon fa-twitter"></a></li><li><a href="https://www.linkedin.com/in/nukemberg/"  target="_blank" class="icon fa-linkedin"></a></li><li><a href="https://github.com/nukemberg" target="_blank" class="icon fa-github"></a></li></ul></div>
...
<div class="row 20% uniform">
        ...
        <!-- <div class="2u"><img src="assets/images/speakers/quinn.png" alt="" width="200" /><ul class="icons"> QUINTESSENCE ANX | DEVELOPER ADVOCATE <br/><li><a href="https://twitter.com/QuintessenceAnx" target="_blank" target="_blank" class="icon fa-twitter"></a></li><li><a href="https://www.linkedin.com/in/quintessenceanx/"  target="_blank" class="icon fa-linkedin"></a></li><li><a href="https://github.com/mdrdannyr" target="_blank" class="icon fa-github"></a></li></ul></div>
